...
abstract class CommonTabFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener(key) { _, data ->
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentButton?.setOnClickListener { setFragmentResult("main1", Bundle().apply { putString("source", source) }) }
